        ...
        fn: async (fen, depth) => {
            ...
            try {
                ...
                return {
                    ...
                    nps: j.nps || 0, timeMs: Date.now() - t0, source: 'lichess',
                };
            } catch { return null; }
        },
    },
        ...
        fn: async (fen, depth) => {
            ...
            try {
                ...
                return {
                    ...
                    nps: j.nps || 0, timeMs: Date.now() - t0, source: 'chess-api.com',
                };
            } catch { return null; }
        },
    },
        ...
        fn: async (fen, depth) => {
            ...
            try {
                ...
                return {
                    ...
                    mate: typeof j.mate === 'number' && j.mate !== 0 ? j.mate : null,
                    nps: j.nps || 0, timeMs: Date.now() - t0, source: 'stockfish.online',
                };
            } catch { return null; }
        },
    },
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    res.setHeader('X-Engine', r.source);
    res.setHeader('X-Engine-Depth', String(r.depth));
